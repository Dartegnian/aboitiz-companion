...
<html lang="en">
	<head>
		...
		<style>
			section#filler {
				background-image: url(assets/images/properties/bataan.jpg);
			}
		...
		function drawChart() {
			...
			data.addRows([
			['Materials & Supply', 324000],
			['Manpower', 1420000],
			['Land Management', 345000],
			['Furniture', 732000],
			['Miscellaneous', 50000]
			]);

			// Set chart options
			var options = {'title':'Bataan Property Breakdown in Phillipine Peso (PHP)',
						'width':900,
						'height':500};
		...
		<section id="content">
			...
			<div id="imagecontainer">
				<div id="image1container" class="images">
					<a href="assets\images\properties\bataan.jpg" target='_blank'>
						<img src="assets\images\properties\bataan.jpg"\>
					</a>
				</div>
			</div>
			<aside id="infospace">
				<p>Bataan is a developing market where you can buy property for cheap and see a sizable return on your investment after a few years.</p>
				<br/>
			...
			<div id="miscstuff">
			<div id="entryfiller" style="float: left; background-image: url(assets/images/companions/mina.jpg);">
					<div id="entry">
