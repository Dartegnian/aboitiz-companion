		...
		<section id="content">
			...
			<div id="imagecontainer">
				<div id="image1container" class="images">
					<a href="assets\images\properties\makati.jpg" target='_blank'>
						<img src="assets\images\properties\makati.jpg"\>
					</a>
				</div>
			</div>
			<aside id="infospace">
				<p>Makati is one of the Philippines' prime spot for properties.</p>
				<br/>
